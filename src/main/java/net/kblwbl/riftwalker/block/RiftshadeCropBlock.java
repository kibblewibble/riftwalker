...
public class RiftshadeCropBlock extends CropBlock {
    public static final int FIRST_STAGE_MAX_AGE = 7;
    public static final int SECOND_STAGE_MAX_AGE = 1;
    public static final IntProperty AGE = IntProperty.of("age", 0, 8);
    private static final VoxelShape[] AGE_TO_SHAPE = new VoxelShape[]{
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 2.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 4.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 6.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 8.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 10.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 12.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 14.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 16.0, 16.0),
            RiftshadeCropBlock.createCuboidShape(0.0, 0.0, 0.0, 16.0, 16.0, 16.0)};

    public RiftshadeCropBlock(Settings settings) { super(settings); }
    ...
    @Override
    protected ItemConvertible getSeedsItem(){ return ModItems.RIFTSHADE_SEEDS; }
